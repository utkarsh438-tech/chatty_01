...
import FriendCard  from "../functionality/FriendCard";
import NoFriendsFound from "../functionality/NoFriendsFound";
                ...
                return (
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      {user.bio && (
                        <>
                          <p className="text-xs font-semibold opacity-50">Bio</p>
