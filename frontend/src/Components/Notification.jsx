...
import NoNotificationsFound from "../functionality/NoNotificationsFound";
                          ...
                          <div className="flex items-center gap-3">
                            <div className="avatar w-14 h-14 rounded-full bg-base-300">
                              {request.sender?.profilePic ? (
                                ...
                                <div className="bg-base-300 w-full h-full rounded-full flex items-center justify-center text-xl">
                                  ?
                                </div>
                              )}
                            </div>
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1.5 mt-1"></div>
                            </div>
                          </div>
